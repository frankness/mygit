...
urlpatterns = [
    ...
    url(r'^authorlist','library.views.authorlist'),
    url(r'^addbook','library.views.addbook'),
    url(r'^booklist','library.views.booklist'),
    url(r'^detail/(\d+)/$','library.views.detail',name="detail"),
    url(r'^delete/(\d+)/$','library.views.delete',name="delete"),
    url(r'^updata/(\d+)/$','library.views.updata',name="updata"),
]
